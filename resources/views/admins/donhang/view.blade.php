    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h2 class="page-title font-24">Đơn hàng {{$donhang->id}}</h2>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active partials_view" id="striped-rows-preview">
                            @include('admins.donhang.partials.partials_view')
                        </div>
                    </div>
                </div>
            </div>
...
@section('link_js')
    ...
    <script src="{{asset('admin_resources/donhang/hoadon.js')}}"></script>
