...
@section('link_css')
    ...
    <link href="{{asset('resource/assets/css/vendor/select.bootstrap5.css')}}" rel="stylesheet" type="text/css">
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h2 class="page-title font-24">Báo cáo thống kê</h2>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title font-20 fw-bold">Doanh thu đạt được</h4>
...
@section('link_js')
    ...
    <script src="{{asset('resource/assets/js/vendor/buttons.html5.min.js')}}"></script>
    <script src="{{asset('resource/assets/js/vendor/buttons.flash.min.js')}}"></script>
    <script src="{{asset('resource/assets/js/vendor/buttons.print.min.js')}}"></script>
    <script src="{{asset('resource/assets/js/vendor/dataTables.keyTable.min.js')}}"></script>
    <script src="{{asset('resource/assets/js/vendor/dataTables.select.min.js')}}"></script>
    <script src="{{asset('resource/assets/js/pages/demo.datatable-init.js')}}"></script>
@endsection
