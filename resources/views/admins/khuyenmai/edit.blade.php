    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h2 class="page-title font-24">Sửa khuyễn mãi</h2>
            </div>
        </div>
    </div>
    <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="tab-pane show active" id="striped-rows-preview">
                                            <div class="form-floating mb-3">
                                                <input name="name" type="text" class="form-control" id="floatingInput" placeholder="Tên danh mục" value="{{$khuyenmai->name}}" required/>
