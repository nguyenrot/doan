    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h2 class="page-title font-24">Thêm sản phẩm khuyến mãi</h2>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('khuyenmai.index')}}" class="btn btn-secondary btn-rounded font-16 ">Quay về</a>
                    <div class="tab-content">
                        <div class="tab-pane show active" id="form-row-preview">
                            <div class="row">
                                <div class="col-3">
                                    <h5 class="mb-1 font-16">Tên khuyến mãi</h5>
                                ...
                                <div class="col-3">
                                    <h5 class="mb-1 font-16">Ngày bắt đầu</h5>
                                    <div class="card text-white bg-danger overflow-hidden">
                                        <div class="card-body">
                                            <div class="toll-free-box text-center">
                                                <h4> <i class="mdi mdi-calendar-start"></i>{{$khuyenmai->ngaybatdau}}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <h5 class="mb-1 font-16">Ngày kết thúc</h5>
                                    <div class="card text-white bg-success overflow-hidden">
                                        <div class="card-body">
                                            <div class="toll-free-box text-center">
                                                <h4> <i class="mdi mdi-calendar-end"></i>{{$khuyenmai->ngayketthuc}}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <h5 class="mb-1 font-16">Trạng thái</h5>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="form-row-preview">
                            <form action="{{route('khuyenmai.post_add_product',['id'=>$khuyenmai->id])}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="mb-1 font-16">Sản phẩm khuyến mãi</h5>
                                        <table class="table tblChiTietKhuyenMai table-bordered border-dark table-centered mt-3 mb-0 font-16">
                                                        ...
                                                        @if($khuyenmai->active!=0)
                                                            <td class="table-action">
                                                                ...
                                                                <label for="{{'switch'.$chitietkhuyenmai->id}}"
                                                                       ...
                                                                       data-off-label="No" class="mb-0 d-block active_sanphamkhuyenmai">
                                                                </label>
                                                            </td>
                                                        @else
                                                            <td>
...
{{--                                                            <button name="tyle" type="button" class="btn btn-outline-dark btn-rounded btnDelete"><i class="fa fa-times"></i></button>--}}
                                ...
                                <div class="mt-3">
                                    @if($khuyenmai->active == 2)
                                        <button name="tyle" type="button" class="btn  btn-rounded"><i class="fa fa-times"></i></button>
                                    @else
                                        <input type="button" value="Thêm sản phẩm" class="btn btn-outline-dark btn-rounded font-16"  id="btnAdd" />
                                        <button type="submit" class="btn btn-primary btn-rounded font-16" >Lưu sản phẩm khuyến mãi</button>
                                    @endif
                                </div>
                            </form>
                        </div>
