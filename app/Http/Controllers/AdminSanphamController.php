...
class AdminSanphamController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admins.sanpham.index', compact('sanphams'));
    }
    ...
    public function create()
    {
        ...
        return view('admins.sanpham.add', compact('danhmucs', 'menus'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admins.sanpham.edit', compact('danhmucsHtml', 'menuHtml', 'sanpham'));
    }
